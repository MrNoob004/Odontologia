...
public class ControladorTurnoPasaporte implements ActionListener, CitaNotificableCorreo {
    EmisionPasaporte vista;
    CitaPasaporte cita;
    ...
    public ControladorTurnoPasaporte(EmisionPasaporte vista) {
    ...
    private void setDatosFijos() {
        vista.elegirFecha.setVisible(false);
    }
    ...
    private void agendarCita() {
        cita = new CitaPasaporte(
                fechaCita,
                Precios.PASAPORTE.getPrecio(),
                solicitante,
                database.getCitaId()
        );
    ...
    private void notificar() {
        ...
        if (enviarCorreo(
                mensaje.toString(),
                "Agendamiento de cita para emision de Pasaporte",
    ...
    private void elegirFecha() {
        ...
        selectorFecha.setTramite("Emision Pasaporte");
